...
Next.js 16.2.6 writes the `plugins`, `.next/dev/types/**/*.ts`, route type import, and generated `NOTE` comment during `next build`. Keep these generated values in source so `pnpm build` does not leave a dirty working tree.
